...
return new #[Title('Admin Notifications')] class extends Component {
    ...
    {
        return app('view')->file('E:\Herd\sagip\storage\framework\views/livewire/views/7f695f57.blade.php', $data);
    }
}; 